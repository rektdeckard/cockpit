package com.tobiasfried.phosphor.adapters;
...
public class LauncherHelper {
	...
	private static final int LAWNCHAIR = 26;
...
//					final Intent lawnchairAction = new Intent("ch.deletescape.lawnchair");
//					lawnchairAction.setAction("ch.deletescape.lawnchair.APPLY_ICONS");
//					lawnchairAction.addCategory(Intent.CATEGORY_DEFAULT);
//					lawnchairAction.putExtra("packageName", context.getPackageName());
//					Log.d("LauncherHelper", "passed package name " + context.getPackageName());
//					lawnchairAction.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//					context.startActivity(lawnchairAction);
//					((AppCompatActivity) context).finish();
